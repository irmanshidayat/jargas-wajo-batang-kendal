# Script Deployment Production dengan Auto-Migration - JALANKAN DI WINDOWS
# Script ini akan deploy kode ke server untuk environment production
# Menggunakan docker-compose.yml dengan .env production
...
Write-Host "Deployment PRODUCTION dengan Auto-Migration" -ForegroundColor Cyan
Write-Host "==========================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "   Domain: jargas.ptkiansantang.com" -ForegroundColor Gray
Write-Host ""

$confirm = Read-Host "⚠️  PERINGATAN: Ini adalah deployment PRODUCTION! Lanjutkan? (y/n)"
...
Write-Host ""
Write-Host "Step 1: Pull kode terbaru dari Git (branch main)..." -ForegroundColor Green
...
Write-Host ""
Write-Host "Step 3: Rebuild Docker containers (production)..." -ForegroundColor Green
...
$healthCmd = "ssh ${Username}@${ServerIP} 'curl -s http://localhost:8001/health || curl -s https://jargas.ptkiansantang.com/api/v1/health'"
try {
...
Write-Host ""
Write-Host "==========================================" -ForegroundColor Cyan
Write-Host "Deployment PRODUCTION Selesai!" -ForegroundColor Green
Write-Host "==========================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "   - Frontend: https://jargas.ptkiansantang.com" -ForegroundColor Gray
Write-Host "   - Backend: https://jargas.ptkiansantang.com/api/v1/health" -ForegroundColor Gray
Write-Host "   - Adminer: https://jargas.ptkiansantang.com:8081" -ForegroundColor Gray
Write-Host ""
