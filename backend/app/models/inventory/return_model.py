...
class Return(BaseModel):
    ...
    quantity_kembali = Column(Numeric(10, 1), nullable=False)
    quantity_kondisi_baik = Column(Numeric(10, 1), nullable=True, default=0)
    quantity_kondisi_reject = Column(Numeric(10, 1), nullable=True, default=0)
